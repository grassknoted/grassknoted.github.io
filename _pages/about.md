...
@keyframes typing {
0.0%, 31.034482758620687% { content: " "; }
0.8620689655172413%, 30.172413793103445% { content: " A"; }
1.7241379310344827%, 29.310344827586203% { content: " AI"; }
2.586206896551724%, 28.44827586206896% { content: " AI "; }
3.4482758620689653%, 27.586206896551722% { content: " AI R"; }
4.310344827586206%, 26.72413793103448% { content: " AI Re"; }
5.1724137931034475%, 25.86206896551724% { content: " AI Res"; }
6.034482758620689%, 24.999999999999996% { content: " AI Rese"; }
6.89655172413793%, 24.137931034482754% { content: " AI Resea"; }
7.758620689655171%, 23.275862068965516% { content: " AI Resear"; }
8.620689655172413%, 22.413793103448274% { content: " AI Researc"; }
9.482758620689655%, 21.551724137931032% { content: " AI Research"; }
10.344827586206897%, 20.68965517241379% { content: " AI Researche"; }
11.206896551724139%, 19.827586206896548% { content: " AI Researcher"; }

32.75862068965517%, 70.6896551724138% { content: " "; }
33.620689655172406%, 69.82758620689656% { content: " S"; }
34.482758620689644%, 68.96551724137932% { content: " So"; }
35.34482758620688%, 68.10344827586206% { content: " Sof"; }
36.20689655172412%, 67.24137931034483% { content: " Soft"; }
37.06896551724136%, 66.37931034482759% { content: " Softw"; }
37.9310344827586%, 65.51724137931035% { content: " Softwa"; }
38.793103448275836%, 64.65517241379311% { content: " Softwar"; }
39.655172413793075%, 63.793103448275865% { content: " Software"; }
40.51724137931031%, 62.93103448275862% { content: " Software "; }
41.37931034482755%, 62.06896551724138% { content: " Software D"; }
42.24137931034479%, 61.20689655172414% { content: " Software De"; }
43.10344827586203%, 60.3448275862069% { content: " Software Dev"; }
43.96551724137927%, 59.48275862068966% { content: " Software Deve"; }
44.827586206896505%, 58.62068965517241% { content: " Software Devel"; }
45.689655172413744%, 57.758620689655174% { content: " Software Develo"; }
46.55172413793098%, 56.896551724137936% { content: " Software Develop"; }
47.41379310344822%, 56.03448275862069% { content: " Software Develope"; }
48.27586206896546%, 55.17241379310345% { content: " Software Developer"; }

72.41379310344827%, 94.82758620689654% { content: "n"; }
73.27586206896551%, 93.9655172413793% { content: "n "; }
74.13793103448275%, 93.10344827586206% { content: "n E"; }
74.99999999999999%, 92.24137931034481% { content: "n Ed"; }
75.86206896551722%, 91.37931034482757% { content: "n Edu"; }
76.72413793103446%, 90.51724137931033% { content: "n Educ"; }
77.5862068965517%, 89.6551724137931% { content: "n Educa"; }
78.44827586206894%, 88.79310344827586% { content: "n Educat"; }
79.31034482758618%, 87.9310344827586% { content: "n Educato"; }
80.17241379310342%, 87.06896551724137% { content: "n Educator"; }
...
I'm a Research Scholar at the <a target="_blank" href="https://www.brown.edu/carney/node/1">Carney Institute for Brain Science</a> at Brown University; I have been exceedingly fortunate to be advised by <a target="_blank" href="https://www.brown.edu/academics/cognitive-linguistic-psychological-sciences/people/faculty/thomas-serre">Prof. Thomas Serre</a>. My research intersects three broad directions:
...
<table align="center" cellspacing="0" cellpadding="0" style="border: none;">
        ...
        <tr>
            <td width="33%" align="center" style="border: none;"><font size="2">Cisco Systems<br>Jan 2019 - Jan 2020</font></td>
            <td width="33%" align="center" style="border: none;"><font size="2">Goldman Sachs<br>Jan 2020 - Sep 2021</font></td>
            <td width="33%" align="center" style="border: none;"><font size="2">Brown University<br>Oct 2021 - Present</font></td>
...
.news-date {
  ...
  color: #000;
  font-size: 0.85em;
  width: 120px; /* Fixed width for the date */
}
.news-content {
  /* color: #000; */
  font-size: 0.95em;
  margin-left: 5px; /* Spacing between the date and the content */
}
</style>
...
<div class="news-section">
  <h3>News</h3>
  <div class="news-item">
    <div class="news-date">Dec,&emsp;2023</div>
    <div class="news-content">Awarded a DeepMind Travel Grant for NeurIPS 2023!</div>
  </div>
  <div class="news-item">
    <div class="news-date">Dec,&emsp;2023</div>
    <div class="news-content">Presenting <a target="_blank" href="https://openreview.net/pdf?id=KeiQNpb7sv">my paper</a> at UniReps, NeurIPS 2023!</div>
  </div>
  <div class="news-item">
    <div class="news-date">Oct,&emsp;&emsp;2023</div>
    <div class="news-content">Presenting <a target="_blank" href="https://www.akashnagaraj.me/files/Closed-loop-optogenetic-system-for-deep-behavioral-phenotyping-Poster.pdf">my poster</a> at SfN 2023!</div>
  </div>
  <div class="news-item">
    <div class="news-date">Aug,&emsp;2023</div>
    <div class="news-content">My mentees, <a target="_blank" href="https://www.linkedin.com/in/samir-samadov-6742a8240/">Samir</a> and <a target="_blank" href="https://www.linkedin.com/in/obinna-okasi-64713a202/">Obinna</a> presented their work at the Leadership</div>
  </div>
    <div class="news-item">
    <div class="news-date"></div>
    <div class="news-content">Alliance <a target="_blank" href="https://theleadershipalliance.org/leadership-alliance-national-symposium">National Symposium</a>!</div>
  </div>
  <div class="news-item">
    <div class="news-date">Jul,&emsp;&emsp;2023</div>
    <div class="news-content">Presenting <a target="_blank" href="https://www.akashnagaraj.me/files/Diffusion-Models-as-Artists.pdf">my paper</a> at ICML 2023!</div>
  </div>
</div>

<h3>Previously</h3>
Before my curent role, I worked on algorithmic trading, high and low touch flows, and a new equities (stocks, bonds, ETFs) trading platform at Goldman Sachs for the better part of two years. I completed my undergraduate education in Computer Science, advised by <a target="_blank" href="https://scholar.google.com/citations?user=1d9F_BoAAAAJ&hl=en">Prof. Dinkar Sitaram</a> and <a target="_blank" href="https://scholar.google.co.in/citations?user=VVznT_IAAAAJ&hl=en">Prof. Sanchika Gupta</a>.
