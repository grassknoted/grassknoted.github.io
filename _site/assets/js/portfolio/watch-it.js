...
<title>watchIt - Akash Nagaraj</title>
...
<meta property="og:title" content="watchIt">
  ...
  <link rel="canonical" href="http://localhost:4000/assets/js/portfolio/watch-it.js">
  <meta property="og:url" content="http://localhost:4000/assets/js/portfolio/watch-it.js">



  <meta property="og:description" content="watchIt is a Smartwatch built entirely from scratch, using an ARM based micro-controller and has multiple sensors and modules to do more than the average Smartwatch at the present time can.">
...
<script src="/assets/js/profile_picture.js"></script>
  ...
  <article class="page" itemscope itemtype="http://schema.org/CreativeWork">
    <meta itemprop="headline" content="watchIt">
    <meta itemprop="description" content="watchIt is a Smartwatch built entirely from scratch, using an ARM based micro-controller and has multiple sensors and modules to do more than the average Smartwatch at the present time can.">
    ...
    <div class="page__inner-wrap">
        ...
        <header>
          <h1 class="page__title" itemprop="headline">watchIt
</h1>
      ...
      <section class="page__content" itemprop="text">
        watchIt is a Smartwatch built entirely from scratch, using an ARM based micro-controller, with a custom Operating System, built over ROS.
The watch has multiple sensors and modules to do more than the average Smartwatch at the present time can.
For instance, it can be used to control Home Appliances via the ESP8266 Module and gets all it's data in real time.
The OS, and Hardware for this watch was built from scratch.
<br>
<br>
<strong>Technologies:</strong> ESP8266, Teensy 4.0, ARM, Lua, C++, C
<style>
  .double-val-label {
 /* display: table; */
...
<ul title="Fruit">
  <li>Developed the mode-based Operating System over ROS.</li>
  <li>Built the hardware for a smartwatch from scratch.</li>
  <li>WiFi and Bluetooth connectivity programming the ESP8266 in Lua</li>
</ul>
