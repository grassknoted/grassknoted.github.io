...
<title>sesh: Simple Elegant Shell - Akash Nagaraj</title>
...
<meta property="og:title" content="sesh: Simple Elegant Shell">


  <link rel="canonical" href="http://localhost:4000/assets/js/portfolio/sesh.js">
  <meta property="og:url" content="http://localhost:4000/assets/js/portfolio/sesh.js">



  <meta property="og:description" content="A simple, elegant Unix shell environment. It supports piping, redirection, history, aliasing, background processes, and customizable functions.">



  <meta name="twitter:site" content="@akash__nagaraj">
  <meta name="twitter:title" content="sesh: Simple Elegant Shell">
  <meta name="twitter:description" content="A simple, elegant Unix shell environment. It supports piping, redirection, history, aliasing, background processes, and customizable functions.">
  <meta name="twitter:url" content="http://localhost:4000/assets/js/portfolio/sesh.js">
...
<script src="/assets/js/profile_picture.js"></script>
  ...
  <article class="page" itemscope itemtype="http://schema.org/CreativeWork">
    <meta itemprop="headline" content="sesh: Simple Elegant Shell">
    <meta itemprop="description" content="A simple, elegant Unix shell environment. It supports piping, redirection, history, aliasing, background processes, and customizable functions.">
    ...
    <div class="page__inner-wrap">
        ...
        <header>
          <h1 class="page__title" itemprop="headline">sesh: Simple Elegant Shell
</h1>
...
<div class="double-val-label"><span class="success">System Design</span></div>
<div class="double-val-label"><span class="primary">Operating Systems</span></div>
<br>
