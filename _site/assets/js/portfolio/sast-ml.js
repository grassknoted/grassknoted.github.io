...
<title>Learning Algorithms to detect Vulnerabilities in Source Code - Akash Nagaraj</title>
...
<meta property="og:title" content="Learning Algorithms to detect Vulnerabilities in Source Code">


  <link rel="canonical" href="http://localhost:4000/assets/js/portfolio/sast-ml.js">
  <meta property="og:url" content="http://localhost:4000/assets/js/portfolio/sast-ml.js">



  <meta property="og:description" content="A project to detect key security vulnerabilities (buffer overflows, SQLi, etc.) in web application source code using a combination of static fuzzing and machine learning. The project is sponsored by Hindustan Computers Limited (a Indian-based multinational IT services company).">



  <meta name="twitter:site" content="@akash__nagaraj">
  <meta name="twitter:title" content="Learning Algorithms to detect Vulnerabilities in Source Code">
  <meta name="twitter:description" content="A project to detect key security vulnerabilities (buffer overflows, SQLi, etc.) in web application source code using a combination of static fuzzing and machine learning. The project is sponsored by Hindustan Computers Limited (a Indian-based multinational IT services company).">
  <meta name="twitter:url" content="http://localhost:4000/assets/js/portfolio/sast-ml.js">
...
<script src="/assets/js/profile_picture.js"></script>
  ...
  <article class="page" itemscope itemtype="http://schema.org/CreativeWork">
    <meta itemprop="headline" content="Learning Algorithms to detect Vulnerabilities in Source Code">
    ...
    <div class="page__inner-wrap">
        ...
        <header>
          <h1 class="page__title" itemprop="headline">Learning Algorithms to detect Vulnerabilities in Source Code
</h1>
...
<div class="double-val-label"><span class="info">ML4Security</span></div>
<div class="double-val-label"><span class="primary">Code Embedding</span></div>
<div class="double-val-label"><span class="warning">NLP</span></div>
<br>
