...
excerpt: "<div><p><img style='object-fit:scale-down; max-height: 150px; display: block; float: left; padding-right: 0.5em; padding-bottom: 0.5em;' src='/images/sesh.png' width='300' height='150'></p>A simple, elegant Unix shell environment. It supports piping, redirection, history, aliasing, background processes, and customizable functions.</div>"
