---
title: "NotePal"
excerpt: "<div><p><img style='object-fit:scale-down; max-height: 150px; display: block; float: left; padding-right: 0.5em; padding-bottom: 0.5em; max-height: 150px;' src='/images/notepal.png' height='50'></p>A simple, intuitive text editor for Linux, with drag and drop functionality, and a GTK based Front End.</div>"
